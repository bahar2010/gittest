<?php
class BrowsehistorytrackingController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
		...
		$datetime		= $this->getRequest ()->getParam ( 'datetime', 'now' );
		$title 			= $this->getRequest ()->getParam ( 'title', 'list' );
		$url 			= $this->getRequest ()->getParam ( 'url', 'list' );
	...
	private function insert($rx_data)
	{
		...
		$data = new Default_Model_DbTable_BrowsehistorytrackingData();
		$data->insert($rx_data);
	}
