...
class Dashboard_AdvanceController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->view->headTitle()->prepend('General Safety Map ');
	...
	public function firemapAction()
    {
        ...
        $this->view->headTitle()->prepend('Fire Safety Map ');
        $id = Zend_Auth::getInstance()->getIdentity()->member_id;
	...
	public function weatherwarningsAction()
    {
		$childID = $this->_request->getParam('id');
        ...
        $this->view->headTitle()->prepend('Weather warnings Map');
        $id = Zend_Auth::getInstance()->getIdentity()->member_id;
	...
	public function naturalhazardsAction()
    {
		$childID = $this->_request->getParam('id');
        ...
        $this->view->headTitle()->prepend('Natural Hazards Map');
        $id = Zend_Auth::getInstance()->getIdentity()->member_id;
	...
	public function earthquakeAction()
    {
		$childID = $this->_request->getParam('id');
        ...
        $this->view->headTitle()->prepend('Earth Quake Map');
        $id = Zend_Auth::getInstance()->getIdentity()->member_id;
