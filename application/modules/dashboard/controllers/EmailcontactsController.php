...
class Dashboard_EmailcontactsController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->view->headTitle()->prepend('Email Contacts  ');
        $id = Zend_Auth::getInstance()->getIdentity()->member_id;
         
        $data = new Default_Model_DbTable_Emailcontacts();
